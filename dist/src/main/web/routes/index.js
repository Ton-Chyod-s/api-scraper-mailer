...
exports.router.post('/mail', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { email, html, ano } = req.body;
        yield (0, send_email_controller_1.enviarEmail)(email, html, ano);
...
exports.router.get('/exercito', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const content = yield exercitoUseCase.execute();
        res.send(content);
    }
    catch (error) {
